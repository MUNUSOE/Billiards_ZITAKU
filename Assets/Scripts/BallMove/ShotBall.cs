...
public class ShotBall : MonoBehaviour
{
    ...
    [Tooltip("Prefab/Effects/StartEffect_Main を登録してください。")]
    ...
    private IEnumerator Start()
    {
        ...
        {
            Debug.LogWarning("[ShotBall] Start Effect PrefabにStartEffect_Mainを登録してください。", this);
            yield break;
        }
    ...
    private void AssignDefaultStartEffect()
    {
        ...
        startEffectPrefab = UnityEditor.AssetDatabase.LoadAssetAtPath<GameObject>(
            "Assets/Prefab/Effects/StartEffect_Main.prefab");
    }
#endif
